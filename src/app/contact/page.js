  ...
  const supportChannels = [
    {
      ...
      href: "mailto:support@fixify.co?subject=[FIXify Support Inquiry]"
    },
    {
      icon: Terminal,
      ...
      href: "mailto:support@fixify.co?subject=[FIXify Schema Customization]"
    },
    {
      icon: ShieldCheck,
      ...
      href: "mailto:security@fixify.co?subject=[FIXify Security Verification]"
    }
  ];
