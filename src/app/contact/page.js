  ...
  const supportChannels = [
    {
      ...
      href: "mailto:support@fixify.mu?subject=[FIXify Support Inquiry]"
    },
    {
      icon: Terminal,
      ...
      href: "mailto:support@fixify.mu?subject=[FIXify Schema Customization]"
    },
    {
      icon: ShieldCheck,
      ...
      href: "mailto:security@fixify.mu?subject=[FIXify Security Verification]"
    }
  ];
